...
public class FormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiOracleProducts = new ApiOracleProducts(getApplicationContext());
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    llenarCampos();
                    apiOracleProducts.insertProdcuto(campo1Insert, campo2Insert, Integer.parseInt(campo3Insert), imgSelected);
                    limpiarCampos();
                    Snackbar.make(v, "Producto ingresado", Snackbar.LENGTH_SHORT).show();
                }catch (Exception e){
        ...
        btnConsultar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                  apiOracleProducts.getProductById(editId.getText().toString().trim(), campo1, campo2, campo3, imgSelected);
            }
        });
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                apiOracleProducts.deleteProducto(editId.getText().toString().trim());
                limpiarCampos();
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                llenarCampos();
                try{
                    apiOracleProducts.updateProducto(
                            Integer.parseInt(editId.getText().toString().toString()),
                            campo1Insert,
                            campo2Insert,
                            Integer.parseInt(campo3Insert),
                            imgSelected
                    );
                    limpiarCampos();
                    Snackbar.make(v, "Producto actualizado", Snackbar.LENGTH_SHORT).show();
                }catch (Exception e){
